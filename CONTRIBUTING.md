# Contributing to SnapFrame.store

Thank you for your interest in contributing to SnapFrame.store! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/snapframe.store.git
   cd snapframe.store
   ```
...
SnapFrame.store requires **Node.js 20+ LTS** and npm.
