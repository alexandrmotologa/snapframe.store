  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-12 space-y-20">
          ...
          <div className="relative z-10 flex flex-col items-center max-w-3xl">
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-10 max-w-2xl">
              {[
                ...
                <span key={f} className="px-3 py-1 rounded-full bg-secondary/60 border border-border/50 text-secondary-foreground text-xs font-medium backdrop-blur-md">
                  {f}
                </span>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5">
              ...
              <Link
                ...
                className={buttonVariants({
                  variant: "outline",
                  size: "lg",
                  className: "px-6 py-6 rounded-2xl text-sm font-semibold border-border/70 hover:bg-secondary/70 gap-2",
                })}
              >
        ...
        <section className="p-6 rounded-3xl bg-card/40 border border-border/60 shadow-xs flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs font-semibold text-muted-foreground">
            <span className="px-2.5 py-1 rounded-lg bg-secondary/60 border border-border/50">iPhone 16 Pro Max (1320×2868)</span>
            <span className="px-2.5 py-1 rounded-lg bg-secondary/60 border border-border/50">iPad Pro 13&quot; (2048×2732)</span>
            <span className="px-2.5 py-1 rounded-lg bg-secondary/60 border border-border/50">Google Play 9:16 &amp; 16:10</span>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-card/60 border border-border/60 space-y-3 shadow-xs hover:border-primary/40 transition-colors">
            ...
            <div className="p-6 rounded-3xl bg-card/60 border border-border/60 space-y-3 shadow-xs hover:border-primary/40 transition-colors">
              <div className="w-10 h-10 rounded-2xl bg-sky-500/10 border border-sky-500/20 text-sky-400 flex items-center justify-center mb-4 shadow-xs">
            ...
            <div className="p-6 rounded-3xl bg-card/60 border border-border/60 space-y-3 shadow-xs hover:border-primary/40 transition-colors">
              <div className="w-10 h-10 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center mb-4 shadow-xs">
            ...
            <div className="p-6 rounded-3xl bg-card/60 border border-border/60 space-y-3 shadow-xs hover:border-primary/40 transition-colors">
              <div className="w-10 h-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center mb-4 shadow-xs">
        ...
        <section className="relative p-10 sm:p-14 rounded-3xl bg-gradient-to-b from-indigo-950/40 via-purple-950/20 to-card border-2 border-indigo-500/40 shadow-2xl text-center space-y-6 overflow-hidden">
