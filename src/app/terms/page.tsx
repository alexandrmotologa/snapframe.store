          ...
          <section className="space-y-3">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="p-3.5 rounded-xl bg-card border border-primary/30 shadow-xs">
                ...
                <p className="text-muted-foreground mt-0.5">
                  Includes <strong>unlimited projects</strong>, automatic real-time <strong>Multi-Device Cloud Synchronization</strong> powered by Google Cloud Firestore (allowing instant seamless access across Mac, PC, and mobile), full <strong>10-screen multi-platform ZIP exports</strong> (iOS, iPadOS, Android, and Tablets), 1-click clipboard PNG copying on all 10 screens, <strong>Custom Canvas Dimensions &amp; Freeform Width × Height</strong>, social media presets (Product Hunt, Twitter/X, Instagram, Web Hero), <strong>Mockup Frame Scaling (50%–150%)</strong>, batch <strong>40+ language localization exports</strong>, complete Fastlane metadata packages, 4K lossless master resolution, Dual Theme generators (1-click Light &amp; Dark matching sets), iPad Pro 13&quot; &amp; Tablet store simulators, all luxury 3D mockup frames (Clay, Glass, Neon, Wireframe), and up to <strong>1,500 AI generations per month</strong> (up to 150/day) governed by our Fair Usage Policy.
                </p>
              </div>
            </div>
